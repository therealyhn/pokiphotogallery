...
export default function ScrollToBottom() {
    ...
    return (
        <button
            ...
            className="fixed top-4 md:right-4 right-2 z-50 bg-main hover:bg-tr transition duration-300 text-black px-6 py-2 rounded-full shadow-lg flex items-center"
        >
